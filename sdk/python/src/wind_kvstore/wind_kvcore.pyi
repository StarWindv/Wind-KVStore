...
class WindKVCore:
    ...
    def __init__(self, path: str, db_identifier: Optional[str] = None) -> None:
        """
        打开或创建一个数据库。
    ...
    def get(self, key: Union[bytes, bytearray]) -> Optional[bytes]:
        """
        根据键获取对应的值。
    ...
    def put(self, key: Union[bytes, bytearray], value: Union[bytes, bytearray]) -> None:
        """
        存储或更新键值对。
    ...
    def delete(self, key: Union[bytes, bytearray]) -> None:
        """
        根据键删除对应的键值对。
